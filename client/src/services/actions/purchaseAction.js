...
export const getPurchaceDetails = (obj) => async (dispatch) => {
  try {
    ...
    dispatch({ type: actionTypes.get_all_from_purchase, payload: data });
  } catch (error) {
...
export const addPurchase = (obj) => async (dispatch) => {
  try {
    ...
    dispatch({ type: actionTypes.add_to_purchase, payload: data });
  } catch (error) {
    console.log(error.message);
  }
};
...
export const updatePurchase = (id, obj) => async (dispatch) => {
  try {
    ...
    dispatch({ type: actionTypes.update_from_purchase, payload: data });
  } catch (error) {
    console.log(error.message);
  }
};
...
export const deletePurchase = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: actionTypes.delete_from_purchase, payload: data });
  } catch (error) {
    console.log(error.message);
  }
};
