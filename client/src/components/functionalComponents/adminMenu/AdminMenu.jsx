...
const AdminMenu = () => {
  ...
  const changeStatus = (val) => {
    ...
    switch (val) {
      ...
      case "Medicines":
        return dispatch(getMedicines(objMedicine));
      case "User Details":
        return dispatch(getUsers(objUsers));
      case "User Roals":
        return dispatch(getUserRoles(objUserRoal));
      case "Store":
        return dispatch(getFromStore(objStore));
      case "Purchase":
        return dispatch(getPurchaceDetails(objPurchase));
      default:
        break;
    }
  };
